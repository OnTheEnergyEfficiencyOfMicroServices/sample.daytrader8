...
To run this sample, first [download](https://github.com/OnTheEnergyEfficiencyOfMicroServices/sample.daytrader8/archive/refs/heads/main.zip) or clone this repo - to clone:
```
